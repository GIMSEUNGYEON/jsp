              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit" id="profile-edit" role="tabpanel">
                  ...
                  <form:form method="post" modelAttribute="empVO" enctype="multipart/form-data" id="myInfoUpdateInfoForm" action="${pageContext.request.contextPath }/emp/myInfo/updateMyInfo.do">
                    <div class="row mb-3">
                      <form:input path="empNo" type="hidden" value="${empUser.empNo}" />
					...
					<c:choose>
	                    ...
	                    <img class="profile-img rounded-circle-profile" style="width: 120px; height: 120px;"
					...
					<input class="form-control" type="file" name="proflImg" id="proflImg"/>
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <form:input path="empAddr" type="text" class="form-control" id="empAddr" value="${empUser.empAddr}" />
                      </div>
                    </div>
