...
<body>
	...
	<form action="formProcess.do" method="post" enctype="application/x-www-form-urlencoded">
		<pre>
			...
			<input type="date" name="dateParam" placeholder="날짜"/>
			<input type="datetime-local" name="dateTimeParam" placeholder="시간"/>
			<label><input type="radio" name="radio" value="Radio01"/>Radio01</label>
			<input type="radio" name="radio" id="radio2" value="Radio02"/><label for="radio2">Radio02</label>
