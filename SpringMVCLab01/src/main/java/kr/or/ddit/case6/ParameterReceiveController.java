...
public class ParameterReceiveController {
	...
	public void handler2(String param1, @RequestHeader("Accept-language") String acceptLanguage, Locale reqLocale) {
		log.info("param1 : {}", param1);
	...
	public void handler4(@RequestParam Map<String, Object> paramerterMap) {
		log.info("파라미터 맵 : {}", paramerterMap);
	}

	@GetMapping("sendParameter5")
	public void handler5(@RequestParam MultiValueMap<String, Object> paramerterMap) {
		log.info("파라미터 맵 : {}", paramerterMap);
	}
